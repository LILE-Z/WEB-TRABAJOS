<Doctype html>
    ...
    <body>
        ...
        print("El resultado de la rests es " . resta() . "<br>");
        ...
        ?>
        <p>EL valor es Dde Pi:<?php print(PI) ?> .</p>
        ...
        $c = 20;
        if ($a < $b) {
            print("El conteneido de b es mayor a a ");
        }
        if ($b > $a) {
            print("A es menor a B");
        }
        if ($b < $c) {
            print("El conenido de la variable b es mayor a");
        } else {
            print("El else");
        }
        if ($a > $c) {
        ...
        switch ($op) {
            ...
            case '/':
                ...
                break;
            default:
                printf("No se econtro esa operacion");
                break;
        }
